...
function cli(options) {
  ...
  this.helpMessage = [
    ...
    , "  -p --png             If SVG or PDF was selected, and you also want PNG, set this flag"
    ...
    , "  -f --pdf             Output PDF instead of PNG"
...
cli.prototype.parse = function(argv, next) {
  ...
  if (options.version) {
    ...
    if ((options.svg || options.pdf) && !options.png) {
      options.png = false
    }
    else {
      options.png = true
